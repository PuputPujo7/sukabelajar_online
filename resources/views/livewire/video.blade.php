<section>
    <div aria-label="group of cards" tabindex="0" class="focus:outline-none p-8 w-full bg-pink-50 px-2 mt-2 rounded">
...
{{--             
            Paket Umroh Retali dibawah PT Retali Mustajab Travel dikelola diarea Jakarta Selatan. 
            Kami beroperasi setiap hari Senin sampai dengan Jum’at untuk mengupdate informasi mengenai harga paket umroh, jadwal keberangkatan umroh, manasik, dan lain-lain. 
            Untuk Anda yang ingin mendapat informasi terbaru dengan cepat terutama mengenai pendaftaran, kami sarankan untuk segera hubungi tombol kontak dibawah, maka tim kami akan segera merespon.
     --}}
            <div class="px-3 md:lg:xl:px-40 border-b py-20 bg-opacity-10">
                <div class="grid grid-cols-1 md:lg:xl:grid-cols-1 group shadow-xl shadow-neutral-100 border ">
            
                    <div
                        class="p-10 flex flex-col items-center text-center group md:lg:xl:border-r md:lg:xl:border-b hover:bg-slate-50 cursor-pointer">
                        {{-- <p class="text-xl font-medium text-slate-700 mt-3">Umroh Ahlu Sunnah Wal Jamaah di Jakarta Hemat</p> --}}
                        {{-- <p class="mt-2 text-sm text-slate-500"> --}}
                            Paket Umroh Retali dibawah PT Retali Mustajab Travel dikelola diarea Jakarta Selatan. 
                            Kami beroperasi setiap hari Senin sampai dengan Jum’at untuk mengupdate informasi mengenai harga paket umroh, jadwal keberangkatan umroh, manasik, dan lain-lain. 
                            Untuk Anda yang ingin mendapat informasi terbaru dengan cepat terutama mengenai pendaftaran, kami sarankan untuk segera hubungi tombol kontak dibawah, 
                            maka tim kami akan segera merespon.
                        {{-- </p> --}}
                    </div>
                </div>
            </div>
                ...
                <div
                    ...
                    <div class="flex flex-col m-5 ">
                        <div class="showreels-div">
                            ...
                            <iframe class="flex items-center" src="https://www.youtube.com/embed/MeooqrrdO4k" frameborder="3" width="350" height="200" allowfullscreen></iframe>
                ...
                <div
                    ...
                    <div class="flex flex-col m-5 ">
                        <div class="showreels-div">
                            ...
                            <iframe class="flex items-center" src="https://www.youtube.com/embed/k6PSlleGWUo" frameborder="3" width="350" height="200" allowfullscreen></iframe>
